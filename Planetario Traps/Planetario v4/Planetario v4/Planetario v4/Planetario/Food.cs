...
namespace Planetario
{
    class Food
    {
        ...
        public Food(Random rand, Rectangle MapRectangle)
        {
            ...
            Сollision = new Rectangle(new Point(rand.Next(MapRectangle.X, MapRectangle.Width + MapRectangle.X - 10), rand.Next(MapRectangle.Y, MapRectangle.Height+ MapRectangle.Y-10)), new Size(bonus * 3 + 10, bonus * 3 + 10));
