...
namespace NormPlanetario
{
    ...
    {
        static public int MapWidth = 800;      // Длина карты
        static public int MapHeight = 500;     // Высота карты
        ...
        static public int FoodMaxOnMap = 20;   // Максимальное количество еды на карте
